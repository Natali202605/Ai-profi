...
export function buildDefaultSiteContent(): SiteContent {
  return {
    ...
    intro: {
      title: "Не просто генерирую. Создаю цельный визуальный образ",
      paragraph1:
        "Каждый проект начинается с понимания вашей идеи, аудитории и задачи. Только после этого подбираются стиль, композиция, цвет, инструменты и формат.",
      paragraph2:
        "Художественный опыт помогает мне видеть проект целиком, а AI-технологии — воплощать сложные идеи в изображениях, видео, сайтах и цифровом оформлении.",
      quote: "",
    },
    about: {
