...
export const processSteps = [
  ...
  },
  {
    step: 2,
    title: "Анализ",
    description: "Изучаю проект, материалы, конкурентов и визуальные ориентиры.",
  },
  {
    step: 3,
    title: "Концепция",
...
export const positioningCards = [
  {
    title: "Вижу",
    description: "Чувствую композицию, цвет, свет и настроение.",
  },
  {
    title: "Продумываю",
    description: "Создаю визуальную концепцию, связанную с задачей проекта.",
  },
  {
    title: "Реализую",
    description: "Превращаю идею в готовые материалы для сайта, рекламы и социальных сетей.",
  },
];
...
export const trustBarItems = [
  ...
  "AI, дизайн и разработка в одном проекте",
  "Работа онлайн",
  "Проекты под задачу клиента",
];
