          ...
          <div className="glass-panel-soft rounded-2xl p-6 md:p-8">
            ...
            <RevealAnimation delay={0.1}>
              ...
              <p className="mb-6 text-lg leading-relaxed text-text-secondary">
                В сообществе{" "}
                <a
                  href="https://vk.com/natali_neero"
                  target="_blank"
                ...
                я также развиваю направление digital-продуктов: сайты под ключ, умные чат-боты,
                нейровидео и визуал для бизнеса. Профессиональное обучение по AI-инструментам и
                vibe-coding подтверждено сертификатами.
              </p>
            </RevealAnimation>
